...
We'll make a simple page that let's the user choose a person's favourite colour.
...
- **Line 5**  
    Uses our `InputColor` component which will render an HTML `<input>` element with `type=color` for the user to interact with.
